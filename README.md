...
- [x] Módulo 3: Generación automatizada de reportes de cotización
- [ ] Módulo 4: Control de gastos de proyectos de sistemas FV a instalarse
- [ ] Módulo 5: Automatizar el dimensionamiento para sistemas de bombeo
