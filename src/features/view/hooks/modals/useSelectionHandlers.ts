...
interface UseSelectionHandlersParams {
  ...
  setSelectedEquipmentByRow: (value: Record<string, { equipoId: string; description: string }> | ((prev: Record<string, { equipoId: string; description: string }>) => Record<string, { equipoId: string; description: string }>)) => void;
  setSelectedMaterialByRow: (value: Record<string, { materialId: string; description: string }> | ((prev: Record<string, { materialId: string; description: string }>) => Record<string, { materialId: string; description: string }>)) => void;
    setSelectedEquipmentTable: (value: SelectedEquipmentItem[] | ((prev: SelectedEquipmentItem[]) => SelectedEquipmentItem[])) => void;
    setSelectedMaterialTable: (value: SelectedMaterialItem[] | ((prev: SelectedMaterialItem[]) => SelectedMaterialItem[])) => void;
}
...
export function useSelectionHandlers({
    ...
    [equipos, materiales, setSelectedEquipmentByRow, setSelectedMaterialByRow]
    );
