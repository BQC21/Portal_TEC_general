...
import { Persona_PriceTable_props } from "@/lib/types/components/Quotes/Quote_tables";

export function Personal_PriceTable({ items, onUpdateItem, onAddItem, onRemoveItem }: Persona_PriceTable_props){
