...
import { Courier_PriceTable_props } from "@/lib/types/components/Quotes/Quote_tables";

export function Courier_PriceTable({ items, onUpdateItem, onAddItem, onRemoveItem }: Courier_PriceTable_props){
