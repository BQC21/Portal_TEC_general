...
import { SCTR_PriceTable_props } from "@/lib/types/components/Quotes/Quote_tables";

export function SCTR_PriceTable({ items, onUpdateItem, onAddItem, onRemoveItem }: SCTR_PriceTable_props){
