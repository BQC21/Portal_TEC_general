                        ...
                        <table className="min-w-full border-separate border-spacing-0">
                            ...
                            <tbody>
                                ...
                                <td className="border-b border-slate-200 px-4 py-5 font-medium">
                                        <AddProductTextField
                                            label="Descripción"
                                            value={manualResourceCosts.tooling.descripcion}
                                            onChange={(value) => updateManualCost("tooling", "descripcion", value)}
                                        />
                                    </td>
                                    <td className="border-b border-slate-200 px-4 py-5 font-medium">
                                        <AddProductNumberField
                                            label="Cantidad"
                                            value={Number(manualResourceCosts.tooling.cantidad ?? 0)} min={0}
                                            onChange={(value) => updateManualCost("tooling", "cantidad", value)}
                                        />
                                    </td>
                                    <td className="border-b border-slate-200 px-4 py-5 font-medium">
                                        <AddProductNumberField
                                            label="Precio Unidad (s/.)"
                                            value={Number(manualResourceCosts.tooling.precio_unitario ?? 0)} min={0}
                                            onChange={(value) => updateManualCost("tooling", "precio_unitario", value)}
                                        />
                                    </td>
                                    <td className="border-b border-slate-200 px-4 py-5 font-medium">
                                        ...
                                        <AddProductReadonlyField
                                            ...
                                            value={formatCurrency(Number(manualResourceCosts.tooling.cantidad ?? 0) * 
                                                Number(manualResourceCosts.tooling.precio_unitario ?? 0), "PEN")}
                                        />
                                    </td>
                                </tr>
