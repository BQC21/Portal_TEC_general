...
import { Tooling_PriceTable_props } from "@/lib/types/components/Quotes/Quote_tables";

export function Tooling_PriceTable({ items, onUpdateItem, onAddItem, onRemoveItem }: Tooling_PriceTable_props){
