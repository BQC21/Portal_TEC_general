...
import { DeleteMaterialModalProps } from "@/lib/types/components/General/modals";
...
export function DeleteMaterialModal({ material, onDeleteMaterial, onClose }: DeleteMaterialModalProps) {
    ...
    async function handleDeleteProduct(event: React.FormEvent<HTMLFormElement>) {
        ...
        await onDeleteMaterial(String(material.id));
        onClose();
    }
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
                <h2 className="text-2xl font-bold text-slate-900">Eliminar Material</h2>
                <button
                    type="button"
                    onClick={onClose}
