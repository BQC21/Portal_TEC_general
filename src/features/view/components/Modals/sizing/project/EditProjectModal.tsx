...
import { createProjectFormStateFromProject } from "@/features/model/mapping/project_mapping";
...
export default function EditProjectModal({
    ...
    const [selectedEquipmentTable, setSelectedEquipmentTable] = useState<SelectedEquipmentItem[]>(() =>
        existingProjectEquipos
            ...
            .map((item) => ({
                ...
                cadenas: item.equipo_info!.cadenas,
    ...
    // Handler para cambiar la opción de demanda eléctrica
    function handleOpcionDemandaLlenadoChange(value: DemandOptions) {
        updateField("opcion_llenado_demanda", value);
    }
            ...
            <div className="flex h-[96vh] max-h-[96vh] w-[96vw] max-w-[1800px] flex-col overflow-hidden rounded-3xl bg-white shadow-2xl">
                ...
                <form noValidate onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
                    ...
                    <Data_info_M2 
                        ...
                        handleOpcionDemandaLlenadoChange={(value) => handleOpcionDemandaLlenadoChange(value as DemandOptions)}
