...
export function AddEquipoModal({ existingEquipos, onAddEquipos, onClose }: AddEquipoModalProps) {
    ...
    const productInfoSelection = shouldRender_EquipoInfoSelection(form.tipo_de_producto);
    const supplierProductCount = existingEquipos.filter((equipo) => equipo.proveedor === form.proveedor).length;
