        ...
        {FILTERS.map((filter) => (
            <label key={filter.id} className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <svg aria-hidden="true" className="pointer-events-none absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
