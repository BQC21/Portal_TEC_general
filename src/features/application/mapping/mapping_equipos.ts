...
import { SupabaseTypeRow } from "@/lib/types/supabase/type-types";
import { mapSupabaseRowToBrand } from "./mapping_marcas";
import { SupabaseBrandRow } from "@/lib/types/supabase/brand.types";
import { mapSupabaseRowToSupplier } from "./mapping_proveedores";
import { SupabaseSupplierRow } from "@/lib/types/supabase/supplier-types";
import { emptyToNull, toDecimalNumber, toNullableInteger } from "@/lib/utils/normalization";
