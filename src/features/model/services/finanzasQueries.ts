import { updateQuoteNombreCotizacion } from "@/features/model/services/QuoteQueries";
import { mapFinantialToSupabaseRow, mapSupabaseRowtoFinantial } from "@/features/model/mapping/mapping_finantial";
