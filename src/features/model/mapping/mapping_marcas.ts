...
import { Brand, BrandFormData, BrandFormstate, SupabaseBrandRow } from "@/lib/types/supabase/brand.types"
import { mapSupabaseRowToSupplier } from "./mapping_proveedores"
import { Supplier, SupabaseSupplierRow } from "@/lib/types/supabase/supplier-types"
import { normalizeAssociationIds, toIntegerIdArray, toNullableInteger } from "@/lib/utils/normalization"
