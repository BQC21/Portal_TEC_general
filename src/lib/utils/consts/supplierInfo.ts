import { SupplierCodeInfo } from "@/lib/types/supabase/supplier-types";

export const EMPTY_SUPPLIER_INFO: SupplierCodeInfo = { RUC: "", supplierCode: "" };

export const LEGACY_SUPPLIER_MAP: Record<string, SupplierCodeInfo> = {
