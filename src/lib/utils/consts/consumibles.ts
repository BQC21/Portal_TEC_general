...
export const CONSUMIBLE_FAMILY_LABEL: Record<ConsumibleSelectableFamily, string> = {
    ...
    tablero: "Tablero",
    canaleta: "Canaleta",
    bornera_linea: "Bornera para línea",
    ...
    tornillo_autorroscante: "Tornillo autorroscante",
...
export const CONSUMIBLE_FAMILY_TIPO: Record<ConsumibleFamily, string> = {
    ...
    tornillo_autorroscante: "CONSUMIBLE",
...
export const GROUPED_CONSUMIBLE_FAMILIES = new Set<ConsumibleFamily>([
    "itm_ac",
    "spd",
    "itm_dc",
    "conduit_flexible",
